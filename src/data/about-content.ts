...
Aqui, a prioridade é clareza e segurança: você entende o que está sendo feito, por quê e quais são os próximos passos. E acompanha tudo pelo aplicativo, com atualizações em tempo real e suporte humano em diferentes canais.`,
    image: '/images/photos/sobre-consultora-verde.webp',
  },
  ...
  pillars: [
    {
      id: 'technology',
      title: 'Tecnologia',
      description: 'Operação sustentada por tecnologia de ponta, garantindo acompanhamento preciso de cada caso.',
    },
    {
      id: 'team',
      title: 'Equipe humana',
      description: 'Consultores financeiros, advogados e negociadores capacitados e em constante evolução.',
    },
    {
      id: 'experience',
      title: 'Experiência',
      description: 'Mais de 600 mil clientes atendidos e mais de R$ 1 bilhão em dívidas reduzidas.',
    },
    {
      id: 'tracking',
      title: 'Acompanhamento',
      description: 'Orientação financeira e jurídica em todas as etapas, do início ao fim.',
    },
  ],
