        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-brand-sky">
              Nossa equipe está pronta para ajudá-lo. Preencha o formulário ou use um dos nossos canais de atendimento.
            </p>
          </div>
        </Container>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                <Card>
                  <div className="flex items-start">
                    <div className="w-12 h-12 rounded-full bg-brand-emerald/10 flex items-center justify-center mr-4 flex-shrink-0">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                <h3 className="font-bold text-brand-navy mb-4">Redes sociais</h3>
                <div className="flex space-x-4">
                  <a
                    href={siteConfig.links.facebook}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-brand-navy text-white flex items-center justify-center hover:bg-brand-emerald transition-colors"
                    aria-label="Facebook"
                  >
